...
const FileBraces = createLucideIcon("file-braces", __iconNode$M);
const __iconNode$L = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$v);
const __iconNode$u = [["path", { d: "M5 12h14", key: "1ays0h" }]];
const Minus = createLucideIcon("minus", __iconNode$u);
const __iconNode$t = [
  [
    "path",
    {
...
const Quote = createLucideIcon("quote", __iconNode$n);
const __iconNode$m = [
